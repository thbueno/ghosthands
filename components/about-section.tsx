      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <div>
            ...
            Over the years I have invest time creating and converting ideas into pixel-perfect, performant, accessible and responsive applications/websites. I have always been captivated about the entire development stack, so i frequently engage in backend too.
            </p>
            <Link
              href="/about"
