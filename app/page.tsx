          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="lg:col-start-2 flex items-center">
                ...
                Virtual greetings to you, I&apos;m Thiago Bueno dos Santo and this is my work space on the Internet. Here you can browse through my current projects, my past works and learn more about me. Feel free!
                </p>
              </div>
            </div>
          </div>
