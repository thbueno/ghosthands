...
services: ['React.js', 'TypeScript', 'Framer Motion', 'Next.js', 'App Router']
websiteUrl: 'https://esthalo.vercel.app/'
category: 'Full Stack'
listingImage: '/images/Esthalo-cat.png'
size: 'small'
galleryImages:
  - '/images/Esthalo-cat.png'
  - '/images/Esthalo-expertise.png'
  - '/images/Esthalo-agents.png'
  - '/images/Esthalo-valores.png'
---
