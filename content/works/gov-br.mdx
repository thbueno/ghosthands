...
headline: 'Replaced timing-out REST endpoints with a GraphQL'
...
websiteUrl: 'https://governancabrasil.com.br/'
category: 'Full Stack & System Design'
listingImage: '/images/govbr_dash3.png'
size: 'small'
galleryImages:
  - '/images/govbr_dash3_zoom.png'
  - '/images/govbr_dash1.png'
  - '/images/govbr_dash2.png'
  - '/images/govbr_Zoom.png'
---
