...
date: ''
client: ''
services: ['React.js', 'Typescript', 'GraphQL', 'Node.js', 'SQLite ', 'Fastify']
websiteUrl: 'https://github.com/thbueno/travel-friends-front'
category: 'Full Stack'
listingImage: '/images/FriendsTravel_screen1.png'
size: 'small'
galleryImages:
  - '/images/FriendsTravel_screen1.png'
  - '/images/FriendsTravel_screen2.png'
  - '/images/FriendsTravel_screen3.png'
---
