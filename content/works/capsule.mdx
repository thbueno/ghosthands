...
websiteUrl: 'https://github.com/thbueno/capsule'
category: 'React Native, UI/UX, Design System'
listingImage: '/images/Capsule_Friends_Mock.png'
size: 'large'
galleryImages:
  - '/images/Capsule_Friends_Mock.png'
  - '/images/Capsule_Chat_Mock.png'
  - '/images/Capsule_Friends_Mock_Zoom.png'
  - '/images/Capsule_Chat_Mock_Zoom.png'
---
